...
const Home = ({ refHome}) => {
    return ( 
        <>
            ...
            >
                <div
                    className='static max-w-250 h-screen flex justify-center'
                >
                    <div
                    ...
                    >
                        <img 
                            src={ ImgHome } alt="" 
                            className='opacity-5 my-20 ml-96'
                        />
                        <div
                            className='absolute h-screen w-full grid grid-cols-1 content-between py-10'
                        >
                            <div
